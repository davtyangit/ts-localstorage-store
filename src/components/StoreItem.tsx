...
export const StoreItem = ({ id, name, price, imgUrl }: StoreItemsProms) => {
  const { getItemQuantity, increaseCardQuantity, decreaseCardQuantity, removeFromCard } =
    useShoppingCard();
